      ...
      <div className="container max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="flex items-center justify-between py-4">
          ...
          <Button
            onClick={handleClick}
            variant={"outline"}
            className="rounded-sm flex font-normal items-center gap-1.5 text-foreground p-1.5 cursor-pointer"
          >
        ...
        <div className="flex flex-col gap-2 py-6">
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 flex gap-3">
            ...
            <p className="text-sm text-primary font-medium ">
              Two-factor authentication secures your account by requiring a code
          ...
          <div className="">
            <div className="bg-destructive/10 border border-destructive/20 rounded-lg p-4 flex items-start justify-between gap-4">
              ...
              <Button
                variant={"secondary"}
                size={"icon"}
                className="bg-transparent hover:bg-destructive/10 cursor-pointer text-destructive hover:text-destructive/80"
              >
