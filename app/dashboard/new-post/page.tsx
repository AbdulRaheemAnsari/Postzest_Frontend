...
const NewPost = () => {
  ...
  return (
    <ProtectedRoute>
      <div className="w-full container max-w-6xl mx-auto flex items-center">
        {/* Left Panel */}
        <div className=" w-[64%] h-[90vh] flex flex-col overflow-y-auto">
          ...
          {/* Select Accounts */}
          <div className="space-y-4 md:py-4 py-3 flex-1 pr-2">
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <Select defaultValue="image">
                  <SelectTrigger className="font-medium w-full py-6">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="image">Image Post</SelectItem>
                    <SelectItem value="video">Video Post</SelectItem>
                    <SelectItem value="carousel">Text Post</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              {uploadedImages.length === 0 ? (
                <div
                  ...
                  className={cn(
                    "group relative border-2 border-dashed rounded-lg pb-1.5 text-center cursor-pointer transition-colors",
                    isDragging
                ...
                >
                  <div className="py-8">
                    <ImagePlus className="relative h-10 w-10 mx-auto mb-3 group-hover:scale-110 group-hover:rotate-6 transition-all duration-100 group-hover:text-primary text-muted-foreground" />
                  ...
                  <div className=" flex border-none px-2 items-center justify-between">
                    <div className="flex items-center gap-1">
                      <Tooltip>
                        <TooltipTrigger>
                          <Button
                            variant={"outline"}
                            className="bg-accent border-none p-2 cursor-pointer"
                          >
                            <Image
                              src={googledrive}
                              alt=""
                        ...
                        <TooltipContent>Select Media from Drive</TooltipContent>
                      </Tooltip>
                      ...
                      <Tooltip>
                        <TooltipTrigger>
                          <Button
                            ...
                            className="bg-accent border-none p-2 cursor-pointer"
                          >
                            <Image src={dropBox} alt="" className="w-5 h-5" />
                          </Button>
                        </TooltipTrigger>
                        <TooltipContent>
                          Select Media from Dropbox
                        </TooltipContent>
                      </Tooltip>
                      <Tooltip>
                        <TooltipTrigger>
                          <Button
                            variant={"outline"}
                            className="bg-accent border-none py-0.5 px-2 cursor-pointer"
                          >
                            <Image src={canva} alt="" className="w-4 h-4" />
                          </Button>
                        </TooltipTrigger>
                        <TooltipContent>Design Image with Canva</TooltipContent>
                      </Tooltip>
                    </div>
                    <Button
                      variant="ghost"
                      size="sm"
                      className="rounded-sm border cursor-pointer border-dashed border-primary text-primary transition-colors bottom-2 hover:text-primary right-2 text-xs hover:bg-primary/4"
                    >
                      <ImagePlus />
                      Generate Image
                    </Button>
          ...
          {/* Footer Actions */}
          <div
            className="bg-background sticky md:pt-4 pt-3 pb-2 pr-2 bottom-0 left-0 flex flex-col sm:flex-row 
                  items-stretch sm:items-center justify-between gap-3 mt-6 z-10"
          >
            <Button
              //   variant="outline"
              onClick={handleSaveDraft}
              className="w-full sm:w-auto bg-accent hover:bg-muted-foreground/16 cursor-pointer py-6 px-4 text-foreground hover:text-foreground rounded-sm"
            >
              Save as Draft
            </Button>
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              <Button
                ...
                className="w-full bg-primary hover:bg-primary/80 font-bold sm:w-auto py-6 px-6 rounded-sm cursor-pointer"
              >
                Post Now
              </Button>
            </div>
        ...
        {/* Right Panel - Preview */}
        <div className="w-[36%] h-[90vh] border-t lg:border-t-0 lg:border-l px-4 md:p-6 py-2">
          <div className="flex items-center gap-2">
          ...
          {/* Instagram Preview */}
          <ScrollArea className="h-[86vh] py-4">
            <div className="bg-accent/50 rounded-xl flex-1 border border-border max-w-md mx-auto">
              <div className="border border-border bg-background rounded-full w-30 h-8 mx-auto mt-4 mb-4" />
              {/* Header */}
              ...
              <div className="p-3 space-y-2">
                ...
                <div>
                  <p className="text-xs ">
                    ...
                    <span className="text-muted-foreground max-w-20 text-wrap">
